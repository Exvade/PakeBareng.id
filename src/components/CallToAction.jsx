      ...
      <div className="max-w-6xl w-full bg-gradient-to-r from-[#070F15]/30 to-[#040A11]/30 backdrop-blur-sm rounded-3xl p-8 shadow-[14px_14px_0px_rgba(2,7,14,0.5)]">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#98EBA6] to-[#78D792] text-2xl md:text-4xl hover:px-2 hover:scale-102 hover:-rotate-1 transition duration-500">
          ...
          <div className="flex justify-center">
            <button className="group relative flex flex-row items-center px-32 py-3 rounded-2xl text-sm sm:text-base bg-[#324a54] hover:bg-[#233941] text-white cursor-pointer overflow-hidden transition-transform duration-500 hover:scale-102 active:scale-97">
