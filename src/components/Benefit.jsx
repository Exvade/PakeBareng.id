...
const benefitCards = [
  {
    title: 'Hemat Biaya',
    description: 'Kamu bisa berbagi biaya langganan dengan member lain, mendapatkan akses ke layanan premium dengan harga terjangkau, serta menikmati sistem pembayaran yang fleksibel dan transparan.',
    icon: salary,
    mainColor: '#47B871',
    shadowColor: '#368F57',
  },
  ...
  },
  {
    ...
    description: 'Kami menerapkan verifikasi member secara ketat. Dengan moderator aktif 24/7 dan kebijakan anti-penyalahgunaan yang ketat, kami memastikan lingkungan yang aman dan nyaman bagi semua pengguna.',
    icon: community,
    mainColor: '#329AE0',
    shadowColor: '#2177B1',
  },
...
export default function BenefitsSection() {
  return (
    <section className="w-full px-4 py-12 bg-dark md:px-6">
