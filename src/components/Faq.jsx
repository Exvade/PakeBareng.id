    ...
    <section className="w-full bg-[#1a1d21] py-12 px-4 md:px-6">
      <div className="flex items-center max-w-6xl gap-20 mx-auto">
        ...
        <div className="w-full md:w-[70%]">
          ...
          <p className="mb-8 text-sm text-center text-gray-400 md:text-left">
            Butuh info lebih lanjut? Cek pertanyaan yang sering ditanyakan di sini. Kalau belum ketemu jawabannya,
            langsung tanyakan di Discord!
          </p>
            ...
            {faqData.map((item, index) => (
              <div key={index} className="border-b border-green">
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={`w-5 h-5 transition-transform duration-200 
                      ${openIndex === index ? "transform rotate-0" : "transform rotate-180"}`}>
                    <path fill="none" stroke="#4EBD77" strokeDasharray="12" strokeDashoffset="12"
                      strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="2" d="M12 8l-7 7M12 8l7 7">
