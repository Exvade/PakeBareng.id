  ...
  return (
    <div className="w-full py-16 overflow-hidden bg-dark">
      <div className="mx-auto">
        <div className="px-4">
          <h2 className="mb-4 text-2xl font-bold text-center text-white md:text-3xl">
            Yang mereka katakan tentang pakebareng.id?
          </h2>
          <p className="max-w-2xl mx-auto mb-12 text-sm text-center text-gray-400">
            Apa kata mereka tentang Pakebareng? Lihat pengalaman pengguna yang sudah merasakan kemudahan berbagi biaya
            langganan di sini! 🚀
          </p>
        </div>
